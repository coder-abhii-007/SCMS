		...
		<div class="container-forms">
			...
			<div class="container-form">
						...
						<div class="table-cell">
							<form action="loginCheck" method="post">
								<input name="email" placeholder="Email" type="text" /><input
									name="pass" placeholder="Password" type="Password" /> <input
				...
				<div class="form-item sign-up">
					<div class="table">
						<div class="table-cell">
							<form action="regesterCheck" method="post">
								<input name="name" placeholder="Name" type="text" /><input
									name="surname" placeholder="Surname" type="text" /><input
									name="email" placeholder="Email" type="text" /><input
									name="pass" placeholder="Password" type="Password" /> <input
...
.container .container-form .btn {
	position: relative;
	box-shadow: 0 0 10px 1px #18FFFF;
	margin-top: 30px;
}
